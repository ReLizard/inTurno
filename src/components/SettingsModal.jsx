        ...
        <div className="p-5 overflow-y-auto flex-1 space-y-4 scrollbar-thin scrollbar-thumb-slate-700">
          ...
          {activeTab === 'shifts' && (
            <div>
              {editingShift ? (
                /* Edit/Create Form */
                <form onSubmit={handleSaveShift} className="space-y-4 bg-slate-950/60 p-4 rounded-2xl border border-slate-800">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full bg-slate-900 border border-slate-700 rounded-xl px-3 py-2 text-sm text-white font-extrabold uppercase focus:outline-none focus:border-yellow-400"
                        required
                      />
                    </div>
                    <div>
                      ...
                      <input
                        ...
                        className="w-full bg-slate-900 border border-slate-700 rounded-xl px-3 py-2 text-sm text-white focus:outline-none focus:border-yellow-400"
                        required
                      />
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        />
                        <span className="text-xs font-mono text-slate-400">{editingShift.color}</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-2 pt-1">
                    ...
                    />
                    <label htmlFor="activeInPalette" className="text-xs font-semibold text-slate-300">
                  ...
                  <div className="flex justify-end gap-2 pt-2">
                    ...
                    <button
                      type="submit"
                      className="px-4 py-2 rounded-xl text-xs font-black bg-yellow-400 text-slate-950 hover:bg-yellow-300 shadow flex items-center gap-1.5"
                    >
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <button
                      ...
                      className="px-3 py-1.5 rounded-xl bg-yellow-400 text-slate-950 font-black text-xs flex items-center gap-1.5 hover:bg-yellow-300 shadow transition-all active:scale-95"
                    >
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                    {shifts.map((s) => (
                      <div
                        key={s.id}
                        className="bg-slate-950/60 border border-slate-800 rounded-2xl p-3 flex items-center justify-between gap-3 group hover:border-slate-700 transition-colors"
                      >
          ...
          {activeTab === 'backup' && (
            <div className="space-y-4">
              <div className="bg-slate-950/60 border border-slate-800 rounded-2xl p-4 space-y-3">
                ...
                <div className="flex flex-wrap gap-3 pt-2">
                  <button
                    ...
                    className="px-4 py-2.5 rounded-xl bg-yellow-400 text-slate-950 font-black text-xs hover:bg-yellow-300 flex items-center gap-2 shadow transition-all active:scale-95"
                  >
                    <Download className="w-4 h-4 stroke-[2.5]" />
                    <span>Scarica Backup (.json)</span>
                  </button>

                  <label className="px-4 py-2.5 rounded-xl bg-slate-800 hover:bg-slate-700 text-slate-200 border border-slate-700 font-bold text-xs flex items-center gap-2 cursor-pointer shadow transition-all active:scale-95">
              ...
              <div className="bg-rose-950/20 border border-rose-900/40 rounded-2xl p-4 flex items-center justify-between gap-3">
                <div>
                ...
                {PRESET_PACKS.map((preset) => (
                  ...
                  >
                    ...
                    <button
                      ...
                      className="px-4 py-2 rounded-xl bg-slate-800 hover:bg-yellow-400 hover:text-slate-950 text-slate-200 font-bold text-xs transition-all shrink-0 border border-slate-700"
                    >
                      Carica Preset
                    </button>
                  </div>
